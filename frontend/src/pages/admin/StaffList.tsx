        ...
        <div className="p-6 max-w-7xl mx-auto space-y-8 relative">
            ...
            >
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Administer faculty accounts across all departments</p>
                </div>
                ...
                >
                    <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 sticky top-6">
                        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-6">
                            ...
                            <p className="text-indigo-100 text-sm mt-1">Create a new faculty account</p>
                        </div>
                        <div className="p-6">
                            ...
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-gray-50">
                                    <tr>
                                        ...
                                        <th className="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Dept & Info</th>
                                            ...
                                            >
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="flex items-center">
                                                        {s.profileImage ? (
                                                            ...
                                                            <div className={`h-10 w-10 rounded-full flex items-center justify-center text-white font-bold shadow-md ${s.isActive ? 'bg-gradient-to-br from-indigo-500 to-purple-600' : 'bg-gray-400'}`}>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="flex flex-col gap-1">
                                                        ...
                                                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold w-fit ${(s as any).role === 'hod' ? 'bg-purple-100 text-purple-800' : 'bg-gray-100 text-gray-800'}`}>
                                                            {((s as any).role === 'hod') ? 'HOD' : 'Staff'}
                                                        </span>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="text-xs text-gray-500 flex flex-col gap-0.5">
                                                        ...
                                                        <span className="font-medium text-gray-700">{s.createdBy?.username || 'System'}</span>
                                                    </div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    {s.isActive ? (
