        ...
        <div className="max-w-7xl mx-auto space-y-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-500 text-sm">Track your grades and attendance across all subjects.</p>
                </div>
                <div className="px-4 py-2 bg-indigo-50 rounded-2xl border border-indigo-100 flex items-center gap-3">
                    <Award className="w-5 h-5 text-indigo-600" />
                    <span className="text-sm font-bold text-indigo-700">Academic Standing: {overallStats.avgMarks > 80 ? 'Excellent' : overallStats.avgMarks > 60 ? 'Good' : 'Needs Improvement'}</span>
                </div>
            </div>
