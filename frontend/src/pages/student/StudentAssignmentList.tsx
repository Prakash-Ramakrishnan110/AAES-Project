                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div>
                            <div className="flex items-center gap-3 mb-3">
                                ...
                                <span className="text-[10px] font-black text-indigo-600 uppercase tracking-[0.3em]">Coursework Analytics</span>
                            </div>
                            ...
                            <p className="text-sm font-bold text-slate-500 uppercase tracking-widest leading-relaxed">
                                Monitor academic progression and submission telemetry
                            </p>
                        </div>
                    </div>
                </div>
