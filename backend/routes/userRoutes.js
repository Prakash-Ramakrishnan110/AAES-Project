...
router.post('/bulk-upload', authorize('admin', 'hod'), upload.single('file'), bulkUploadUsers);

router.get('/stats/system', authorize('admin', 'hod'), getSystemStats);
...
router.get('/audit-logs', authorize('admin', 'hod'), getAuditLogs);
